...
const SAMPLE_QUESTIONS: Record<string, string[]> = {
  "mahsumah-cloud": ["ما هي أفضل باقة لموقعي؟", "كيف أنشر تطبيق Next.js؟", "أين توجد الخوادم؟ وهل البيانات تبقى في السعودية؟", "حالة النشر فشلت، ما السبب؟", "افتح لي تذكرة دعم: النطاق لا يعمل", "ما هي فاتورتي القادمة؟", "هل تدعمون PHP؟"],
  "mahsumah": ["ما هي محسومة وما منتجاتها؟", "أبي أستضيف موقعي، أي منتج يناسبني؟", "كيف أتابع مؤشرات أداء شركتي؟", "كيف أتواصل مع المبيعات؟"],
  "mahsumah-dcc": ["كم عدد المؤشرات في باقة الفريق؟", "ما التكاملات المتاحة مع Power BI؟", "اقترح لي الباقة المناسبة لجهة حكومية", "كيف أبدأ إعداد المنشأة؟", "ما هو سعر محسومة كلاود؟"],
};
